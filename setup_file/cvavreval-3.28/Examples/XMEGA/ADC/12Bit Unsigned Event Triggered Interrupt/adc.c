...
// Event System Channel 1 source: Timer/Counter C0 Overflow
EVSYS.CH1MUX=EVSYS_CHMUX_TCC0_OVF_gc;
// Event System Channel 2 source: Timer/Counter C0 Overflow
EVSYS.CH2MUX=EVSYS_CHMUX_TCC0_OVF_gc;
// Event System Channel 3 source: Timer/Counter C0 Overflow
...
// Event channel(s): 0, 1, 2, 3 trigger(s) ADC channel(s): 0, 1, 2, 3
ADCA.EVCTRL=ADC_EVSEL_0123_gc | ADC_EVACT_CH0123_gc;
...
// Event System initialization
// TCC0 overflow event is used by event channels 0..3
event_system_init();

// Timer/Counter TCC0 initialization
// It will generate overflow events on channels 0..3 every 1000ms
tcc0_init();
