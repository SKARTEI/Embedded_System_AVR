...
// Product string
#define USB_STR_PRODUCT 'C','o','d','e','V','i','s','i','o','n','A','V','R',' ','C','o','m','p','o','s','i','t','e',' ','D','e','v','i','c','e'
// Number of characters in the product string
#define USB_STR_PRODUCT_CHARS 30
...
#define USB_INTERFACE2_IN_EP_SIZE 8
#define USB_INTERFACE2_IN_EP_SERVICE_INTERVAL 5

// Interface 3 IN endpoint settings
#define USB_INTERFACE3_IN_EP 4
#define USB_INTERFACE3_IN_EP_SIZE 8
#define USB_INTERFACE3_IN_EP_SERVICE_INTERVAL 5
