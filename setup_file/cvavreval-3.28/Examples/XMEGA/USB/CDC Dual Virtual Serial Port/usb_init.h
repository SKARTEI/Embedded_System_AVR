...
// Product string
#define USB_STR_PRODUCT 'C','o','d','e','V','i','s','i','o','n','A','V','R',' ','D','u','a','l',' ','V','i','r','t','u','a','l',' ','S','e','r','i','a','l',' ','P','o','r','t'
// Number of characters in the product string
#define USB_STR_PRODUCT_CHARS 38
...
// Interface 2 IN endpoint settings
#define USB_INTERFACE2_IN_EP 3
#define USB_INTERFACE2_IN_EP_SIZE 16
#define USB_INTERFACE2_IN_EP_SERVICE_INTERVAL 255

// Interface 3 IN endpoint settings
#define USB_INTERFACE3_IN_EP 4
#define USB_INTERFACE3_IN_EP_SIZE 64

// Interface 3 OUT endpoint settings
#define USB_INTERFACE3_OUT_EP 4
#define USB_INTERFACE3_OUT_EP_SIZE 64
