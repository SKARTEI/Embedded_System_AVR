...
Project : USB CDC Dual Virtual Serial Port Example
*******************************************************/
...
// Interface 2 Association Descriptor
USB_INTERFACE_ASSOC_DESCRIPTOR_t interface_assoc_descriptor2;

// Interface 2 - CDC Control
USB_INTERFACE_DESCRIPTOR_t interface_descriptor2;
USB_CDC_HEADER_FUNC_DESCRIPTOR_t cdc_header_func_descriptor2;
USB_CDC_ACM_FUNC_DESCRIPTOR_t cdc_acm_func_descriptor2;
USB_CDC_UNION_FUNC_DESCRIPTOR_t cdc_union_func_descriptor2;
...
USB_ENDPOINT_DESCRIPTOR_t interface_out_endpoint_descriptor3;
...
.bDescriptorType=USB_DESCRIPTOR_TYPE_CS_INTERFACE,
.bDescriptorSubtype=CDC_DST_UNION,
.bMasterInterface=2, // Interface 2 is used for Control
.bSlaveInterface0=3  // Interface 3 is used for Data
},
...
.bLength=sizeof(USB_INTERFACE_DESCRIPTOR_t),
.bDescriptorType=USB_DESCRIPTOR_TYPE_INTERFACE,
.bInterfaceNumber=3, // Interface 3 is used for Data
.bAlternateSetting=USB_ALTERNATE_SETTING_NONE,
.bNumEndpoints=2,
.bInterfaceClass=USB_CLASS_COMM_DEV_DATA,
.bInterfaceSubClass=USB_SUBCLASS_NONE,
...
.bLength=sizeof(USB_ENDPOINT_DESCRIPTOR_t),
.bDescriptorType=USB_DESCRIPTOR_TYPE_ENDPOINT,
.bEndpointAddress=USB_INTERFACE3_OUT_EP | USB_ENDPOINT_DIR_OUT,
.bmAttributes=USB_TRANSFER_BULK | USB_EP_ATTR_NO_SYNC | USB_EP_USAGE_DATA,
.wMaxPacketSize=USB_INTERFACE3_OUT_EP_SIZE,
.bInterval=0
},
...
.bInterfaceClass=USB_CLASS_COMM_DEV_COMM,
.bInterfaceProtocol=USB_PROTOCOL_CDC_AT,
.report_data=&usb_cdc_serial[1].parameters,
.report_size=sizeof(USB_CDC_LINE_CODING_t),
// IN endpoint configuration
...
.report_size=0,
// IN endpoint configuration
.in={.ep=USB_INTERFACE3_IN_EP,.type=USB_TRANSFER_BULK,.size=USB_INTERFACE3_IN_EP_SIZE},
// OUT endpoint configuration
.out={.ep=USB_INTERFACE3_OUT_EP,.type=USB_TRANSFER_BULK,.size=USB_INTERFACE3_OUT_EP_SIZE}
}
},
