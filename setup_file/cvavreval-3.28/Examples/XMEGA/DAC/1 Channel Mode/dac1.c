/*
Sample program to test the ATxmega128A1 DACA in single
...
An 100Hz, 1V peak to peak, sinusoidal waveform will be
present on the DACA channel 0 output DAC0 on PORTA pin 2.
*/
...
// Conversion interval: 2.000us (4 ClkPer cycles)
DACA.TIMCTRL=(DACA.TIMCTRL & (~(DAC_CONINTVAL_gm | DAC_REFRESH_gm))) |
	DAC_CONINTVAL_4CLK_gc | DAC_REFRESH_OFF_gc;
