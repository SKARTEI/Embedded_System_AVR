...
/* ATxmega256C3 I/O register definitions */
...
USARTD0.BAUDCTRLA=0xC5;
USARTD0.BAUDCTRLB=((0x0A << USART_BSCALE_gp) & USART_BSCALE_gm) | 0x0C;
...
/* initialize the USARTD0 TX, 8N1, Baud rate: 9600 */
usartd0_init();
