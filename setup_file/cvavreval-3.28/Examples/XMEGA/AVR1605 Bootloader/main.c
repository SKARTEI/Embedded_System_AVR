/*****************************************************************************
Port of Atmel Application Note AVR1605 fot the CodeVisionAVR C Compiler
Copyright (C) 2009 HP InfoTech s.r.l., Pavel Haiduc

Before using, please read the AVR1605 Application Note from:
...
*
* File              : main.c
* Compiler          : CodeVisionAVR V2.04.2
* Revision          : $Revision: 1.8 $
* Date              : $Date: June 08, 2009 $
* Updated by        : $Author: hp $
*
...
*
* Preparations  : Modify the defines.h file to suit the device you are compiling for.
****************************************************************************/
...
#pragma diag_suppress=Pe1053 // Suppress warning for conversion from long-type address to flash ptr.
#endif
                SP_LoadFlashWord( (uint16_t) (address << 1), temp_int );
#ifdef __ICCAVR__
#pragma diag_default=Pe1053 // Back to default.
#endif
                address++; // Auto-advance to next Flash word.
...
#pragma diag_suppress=Pe1053 // Suppress warning for conversion from long-type address to flash ptr.
#endif
            SP_LoadFlashWord( (uint16_t) *address, data);
#ifdef __ICCAVR__
#pragma diag_default=Pe1053 // Back to default.
#endif
