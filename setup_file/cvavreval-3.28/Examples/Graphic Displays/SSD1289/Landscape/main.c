...
the contents of the
\EXAMPLES\Graphic Displays\SSD1289\Landscape\Exe\demo_landscape.hex
file.
...
The display module is operated in landscape 320x240 mode. 
...
/* Horizontally reversed for HY32D */
glcd_init_data.reverse_x=SSD1289_REVX_REV;
/* Vertically reversed for HY32D */
glcd_init_data.reverse_y=SSD1289_REVY_REV;
...
glcd_outtextf("Solomon Systech SSD1289 Landscape Graphics Demo\n"
