...
the contents of the
\EXAMPLES\Graphic LCD\ILI9341 Landscape\Exe\demo_landscape.hex
file.
...
A type NHD-2.4-240320SF-CTXI-F1
...
glcd_init_data.reverse_x=ILI9341_REVX_NORM;
...
glcd_outtextf("Ilitek ILI9341 Landscape Graphics Demo\n"
