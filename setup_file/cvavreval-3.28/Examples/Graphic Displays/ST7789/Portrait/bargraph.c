...
#define CHAR_WIDTH (5+1) /* font 5x7 char. width + 1 horizontal spacing pixel */
#define CHAR_HEIGHT (7+1)  /* font 5x7 char. height + 1 vertical spacing pixel */
...
glcd_setfillcolor(GLCD_CL_BLACK);
glcd_barrel(pb->xt+(pb->width-CHAR_WIDTH*(BUFFER_SIZE-1))/2,y,CHAR_WIDTH*(BUFFER_SIZE-1),CHAR_HEIGHT);
/* convert value to decimal */
