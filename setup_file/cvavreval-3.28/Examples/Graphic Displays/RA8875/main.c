...
glcd_outtextf("RAiO Technology RA8875 Graphics Demo\n"
...
glcd_setfont(courier_bold14);
glcd_setcolor(GLCD_CL_YELLOW);
glcd_outtextf("RA8875 TFT Controller\n");
...
/* Display a triangle */
glcd_setcolor(GLCD_CL_GREEN);
glcd_triangle(5,209,55,209,30,173);

/* Display a filled triangle */
/* Set fill pattern and color */
glcd_setfillf(solid_fill,GLCD_CL_VIOLET);
glcd_filltriangle(65,209,115,209,90,173);

glcd_setfont(font5x7);
glcd_setcolor(GLCD_CL_YELLOW);
glcd_outtextxyf(32,215,"Triangles");

/* Display an ellipse */
glcd_setcolor(GLCD_CL_BLUE);
glcd_ellipse(150,190,20,15);

/* Display a filled ellipse */
/* Set fill pattern and color */
glcd_setfillf(solid_fill,GLCD_CL_RED);
glcd_fillellipse(195,190,20,15);

glcd_setcolor(GLCD_CL_YELLOW);
glcd_outtextxyf(150,215,"Ellipses");

glcd_outtextxyf(0,231,"Display\nan image\nfrom\nRAM:");

/* Display image saved in RAM
   without transparency */
glcd_putimage(50,231,buffer,GLCD_PUTCOPY);

glcd_outtextxyf(0,276,"Non-transparent mode");
...
/* Display image saved in RAM
   with transparency */
glcd_putimage(150,231,buffer,GLCD_PUTTP);

glcd_outtextxyf(130,276,"Transparent mode");
