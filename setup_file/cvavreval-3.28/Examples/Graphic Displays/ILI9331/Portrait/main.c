...
the contents of the
\EXAMPLES\Graphic Displays\ILI9331\Portrait\Exe\demo_portrait.hex
file.
...
/* Set the ATxmega128A1U to run from the internal 32MHz oscillator */
system_clocks_init();

/* Turn on the display backlight */
PORTF.DIRSET=1<<5; /* PORTF bit 5 is an output */
PORTF.OUTSET=1<<5; /* PORTF bit 5=1 */
...
glcd_init_data.reverse_x=ILI9331_REVX_REV;
/* Vertical display reversed */
glcd_init_data.reverse_y=ILI9331_REVY_REV;
/* Color bit writing order: BGR */
glcd_init_data.cl_bits_order=ILI9331_CL_BITS_BGR;
/* Power control 1 BT0..BT2 step-up factor of the step-up circuit */
glcd_init_data.stepup_factor=ILI9331_DEFAULT_STEPUP_FACTOR;
/* Power control 2 DC00..DC02, step-up circuit 1 frequency */
glcd_init_data.stepup_freq1=ILI9331_DEFAULT_STEPUP1_FREQ;
/* Power control 2 DC10..DC12, step-up circuit 2 frequency */
glcd_init_data.stepup_freq2=ILI9331_DEFAULT_STEPUP2_FREQ;
...
glcd_init_data.crt_source=ILI9331_DEFAULT_CRT_SOURCE;
/* Default value for VREG1OUT voltage */
glcd_init_data.vreg1out=ILI9331_DEFAULT_VREG1OUT;
/* Default value for Vcom alternating drive voltage */
glcd_init_data.vcom=ILI9331_DEFAULT_VCOM;
/* Default value for VcomH voltage */
glcd_init_data.vcomh=ILI9331_DEFAULT_VCOMH;
/* Frame frequency */
glcd_init_data.frame_freq=ILI9331_DEFAULT_FRAME_FREQ;
/* KP00..KP02 positive gamma micro adj. */
glcd_init_data.kp00=ILI9331_DEFAULT_KP00;
/* KP10..KP12 positive gamma micro adj. */
glcd_init_data.kp10=ILI9331_DEFAULT_KP10;
/* KP20..KP22 positive gamma micro adj. */
glcd_init_data.kp20=ILI9331_DEFAULT_KP20;
/* KP30..KP32 positive gamma micro adj. */
glcd_init_data.kp30=ILI9331_DEFAULT_KP30;
/* KP40..KP42 positive gamma micro adj. */
glcd_init_data.kp40=ILI9331_DEFAULT_KP40;
/* KP50..KP52 positive gamma micro adj. */
glcd_init_data.kp50=ILI9331_DEFAULT_KP50;
/* RP00..RP02 positive gamma gradient adj. */
glcd_init_data.rp00=ILI9331_DEFAULT_RP00;
/* RP10..RP12 positive gamma gradient adj. */
glcd_init_data.rp10=ILI9331_DEFAULT_RP10;
/* VRP00..VRP03 positive gamma amplification adj. */
glcd_init_data.vrp00=ILI9331_DEFAULT_VRP00;
/* VRP10..VRP14 positive gamma amplification adj. */
glcd_init_data.vrp10=ILI9331_DEFAULT_VRP10;
/* KN00..KN02 negative gamma micro adj. */
glcd_init_data.kn00=ILI9331_DEFAULT_KN00;
/* KN10..KN12 negative gamma micro adj. */
glcd_init_data.kn10=ILI9331_DEFAULT_KN10;
/* KN20..KN22 positive gamma micro adj. */
glcd_init_data.kn20=ILI9331_DEFAULT_KN20;
/* KN30..KN32 positive gamma micro adj. */
glcd_init_data.kn30=ILI9331_DEFAULT_KN30;
/* KN40..KN42 negative gamma micro adj. */
glcd_init_data.kn40=ILI9331_DEFAULT_KN40;
/* KN50..KN52 negative gamma micro adj. */
glcd_init_data.kn50=ILI9331_DEFAULT_KN50;
/* RN00..RN02 negative gamma gradient adj. */
glcd_init_data.rn00=ILI9331_DEFAULT_RN00;
/* RN10..RN12 negative gamma gradient adj. */
glcd_init_data.rn10=ILI9331_DEFAULT_RN10;
/* VRN00..VRN03 negative gamma amplification adj. */
glcd_init_data.vrn00=ILI9331_DEFAULT_VRN00;
/* VRN10..VRN14 negative gamma amplification adj. */
glcd_init_data.vrn10=ILI9331_DEFAULT_VRN10;
...
glcd_outtextf("Ilitek ILI9331 Graphics Demo\n"
...
glcd_setfont(courier_bold14);
glcd_setcolor(GLCD_CL_YELLOW);
glcd_outtextf("ILI9331 TFT Controller\n");
...
PORTF.OUTCLR=1<<5; /* Turn off baclight, PORTF bit 5=0 */
...
PORTF.OUTSET=1<<5; /* Turn on backlight, PORTF bit 5=1 */
