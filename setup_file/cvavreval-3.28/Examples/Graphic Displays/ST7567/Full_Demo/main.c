...
init.reverse_x=ST7567_DEFAULT_REVX;
init.rev132_x0=ST7567_DEFAULT_REV132_X0;
/* Set vertical scan direction: reversed */
init.reverse_y=ST7567_REVY_REV;

init.volt_reg_ratio=ST7567_DEFAULT_VOLT_REG_RATIO;
init.lcd_bias=ST7567_DEFAULT_LCD_BIAS;
init.booster_level=ST7567_DEFAULT_BOOSTER_LEVEL;
init.lcd_contrast=ST7567_DEFAULT_CONTRAST;

/* Initialize the LCD controller and graphics */
glcd_init(&init);

/* Display literal char string located in FLASH */
glcd_outtextf("ST7567 Graphics Demo\nFont samples:");
