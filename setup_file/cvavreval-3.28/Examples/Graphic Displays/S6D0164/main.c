...
glcd_init_data.reverse_x=S6D0164_REVX_REV;
/* The display is vertically reversed */
glcd_init_data.reverse_y=S6D0164_REVY_REV;
/* Color bit writing order: BGR */
glcd_init_data.cl_bits_order=S6D0164_CL_BITS_BGR;
/* Display type: normally white */
glcd_init_data.lcd_type=S6D0164_LCD_TYPE_WHITE;
/* VCI1 voltage */
glcd_init_data.vci1=S6D0164_DEFAULT_VCI1;
/* VCOML voltage */
glcd_init_data.vcoml=S6D0164_DEFAULT_VCOML;
/* VCOMH voltage */
glcd_init_data.vcomh=S6D0164_DEFAULT_VCOMH;
/* Gamma voltage GVDD */
glcd_init_data.gamma_voltage=S6D0164_DEFAULT_GAMMA_VOLTAGE;
/* Gamma adjustment */
glcd_init_data.gamma_control=S6D0164_DEFAULT_GAMMA;

glcd_init(&glcd_init_data);

/* Display literal char string located in FLASH */
glcd_outtextf("Samsung S6D0164 Landscape Mode\n"
              "Graphics Demo\n"
