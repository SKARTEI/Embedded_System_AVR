...
the contents of the
\EXAMPLES\Graphic LCD\SSD1289 Arduino Landscape\Exe\demo_landscape.hex
file.
...
connection, 64k color mode, in landscape 320x240
configuration.
...
- The DIP switches 1 and 2 on the TFT module must be
...
glcd_init_data.reverse_x=SSD1289_REVX_NORM;
...
glcd_outtextf("Solomon Systech SSD1289 8 bit Graphics Demo\n"
