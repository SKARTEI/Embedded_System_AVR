...
USB_HID_INTERFACE_DESCRIPTOR_t interface_hid_descriptor1;
...
.bInterval=USB_INTERFACE1_IN_EP_SERVICE_INTERVAL
}
};
...
{0,USB_DESCRIPTOR_TYPE_HID_INTERFACE,1 /* Interface # */,&usb_config_descriptor.interface_hid_descriptor1,sizeof(USB_HID_INTERFACE_DESCRIPTOR_t)},
{0,USB_DESCRIPTOR_TYPE_REPORT,1 /* Interface # */,hid_joystick_report_descriptor,sizeof(hid_joystick_report_descriptor)},
...
// IN endpoint configuration
.in={.ep=USB_INTERFACE1_IN_EP,.type=USB_TRANSFER_INTERRUPT,.size=USB_INTERFACE1_IN_EP_SIZE}
}
},
