...
// Product string
#define USB_STR_PRODUCT 'C','o','d','e','V','i','s','i','o','n','A','V','R',' ','C','o','m','p','o','s','i','t','e',' ','U','S','B',' ','D','e','v','i','c','e'
// Number of characters in the product string
#define USB_STR_PRODUCT_CHARS 34
...
#define USB_INTERFACE1_IN_EP 4
#define USB_INTERFACE1_IN_EP_SIZE 8
#define USB_INTERFACE1_IN_EP_SERVICE_INTERVAL 5
