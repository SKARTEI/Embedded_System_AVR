 ...
 * Modified for CodeVisionAVR V3.xx by HP InfoTech
 * See: http://eewiki.net/display/microcontroller/CAN+Example+-+ATmega32M1+-+STK600
 */ 
    ...
    {	
		...
		if(Read_Button()) { 
			...
			for(j=0; j<NB_TARGET; j++) {
				...
				delay_msec(50); // Wait 50ms for a response
