/*******************************************************************
Bosch BME280 Humidity Pressure Sensor Example
...
Note: The BME280 sensor is sensitive to light.
...
\Examples\AVR\Pressure Sensors\BME280\Release\Exe\bme280 demo.hex 
...
// Delay functions
#include <delay.h>
// BME280 Pressure sensor functions
...
printf("BME280 Pressure and humidity sensor demo\r\n");

// Initialize the BME280 sensor
// Use the Ultra High Resolution Mode for pressure
// 2 times oversampling for humidity
check_result(bme280_init(BME280_I2C_ADDR_SDO_LOW,BME280_ULTRA_HI_RES_MODE,
    BME280_FILTER_COEFF_8,BME280_OVERSAMP_2X));
