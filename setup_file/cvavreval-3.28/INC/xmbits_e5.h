...
Peripheral Modules definitions for the ATxmega E5 chips
*************************************************************************/

#ifndef __XMBITS_E5_INCLUDED__
#define __XMBITS_E5_INCLUDED__
...
/* For compatibility with other chips, 05062014_1 */
#define ADC_REFSEL_VCCDIV2_gc ADC_REFSEL_INTVCC2_gc
...
typedef enum DAC_REFSEL_enum
{
    ...
    DAC_REFSEL_AREFD_gc = (0x03<<3),  /* External reference on AREF on PORTD, 23122013_3 */
} DAC_REFSEL_t;
...
#define SPI_SCK_bm 0x20 // Bit mask for the SCK pin
#define SPI_MISO_bm 0x40 // Bit mask for the MISO pin
#define SPI_MOSI_bm 0x80 // Bit mask for the MOSI pin
...
#define PORTCFG_SRLENA_bm  0x01  /* Slew Rate Limit Enable on PORTA bit mask. */
#define PORTCFG_SRLENA_bp  0  /* Slew Rate Limit Enable on PORTA bit position. */

#define PORTCFG_SRLENC_bm  0x04  /* Slew Rate Limit Enable on PORTC bit mask. */
#define PORTCFG_SRLENC_bp  2  /* Slew Rate Limit Enable on PORTC bit position. */

#define PORTCFG_SRLEND_bm  0x08  /* Slew Rate Limit Enable on PORTD bit mask. */
#define PORTCFG_SRLEND_bp  3  /* Slew Rate Limit Enable on PORTD bit position. */

#define PORTCFG_SRLENR_bm  0x80  /* Slew Rate Limit Enable on PORTR bit mask. */
#define PORTCFG_SRLENR_bp  7  /* Slew Rate Limit Enable on PORTR bit position. */
...
#define AC_CURRMODE_bm  0x40  /* Current Source mode bit mask. */
#define AC_CURRMODE_bp  6  /* Current Source mode bit position. */
