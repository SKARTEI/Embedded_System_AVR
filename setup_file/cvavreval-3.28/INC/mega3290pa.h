...
// I/O registers definitions for the ATmega3290A/PA

#ifndef _MEGA3290A_INCLUDED_
#define _MEGA3290A_INCLUDED_
...
#define PINH (*(unsigned char *) 0xd8)
#define DDRH (*(unsigned char *) 0xd9)
#define PORTH (*(unsigned char *) 0xda)
#define PINJ (*(unsigned char *) 0xdb)
#define DDRJ (*(unsigned char *) 0xdc)
#define PORTJ (*(unsigned char *) 0xdd)
...
#define LCDDR04 (*(unsigned char *) 0xf0)
...
#define LCDDR09 (*(unsigned char *) 0xf5)
...
#define LCDDR14 (*(unsigned char *) 0xfc)
...
#define LCDDR19 (*(unsigned char *) 0xff)
