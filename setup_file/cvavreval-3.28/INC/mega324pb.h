...
// I/O registers definitions for the ATmega324PB

#ifndef _MEGA324PB_INCLUDED_
#define _MEGA324PB_INCLUDED_
...
sfrb SPSR0=0x2d;
sfrb SPDR0=0x2e;
// for compatibility with SPI library, which uses SPI0
sfrb SPCR=0x2c;
sfrb SPSR=0x2d;
sfrb SPDR=0x2e;
...
#define PCMSK4 (* (unsigned char *) 0x74)
...
// for compatibility with TWI library, which uses TWI0
...
#define SNOBR8 (*(unsigned char *) 0xf0)
#define SNOBR7 (*(unsigned char *) 0xf1)
#define SNOBR6 (*(unsigned char *) 0xf2)
#define SNOBR0 (*(unsigned char *) 0xf3)
#define SNOBR1 (*(unsigned char *) 0xf4)
#define SNOBR2 (*(unsigned char *) 0xf5)
#define SNOBR3 (*(unsigned char *) 0xf6)
#define SNOBR4 (*(unsigned char *) 0xf7)
#define SNOBR5 (*(unsigned char *) 0xf8)
...
#define TIM3_OVF 35
#define USART0_START 36
#define USART1_START 37
#define PC_INT4 38
#define CFD 39
#define PTC_EOC 40
#define PTC_WCOMP 41
...
#define TWI1 43
#define TIM4_CAPT 44
#define TIM4_COMPA 45
#define TIM4_COMPB 46
#define TIM4_OVF 47
#define USART2_RXC 48
#define USART2_DRE 49
#define USART2_TXC 50
#define USART2_START 51
