...
ATmega16M1, ATmega32M1, ATmega64M1 I/O REGISTERS BIT DEFINITIONS
*/

#ifndef __MEGA64M1_BITS_INCLUDED__
#define __MEGA64M1_BITS_INCLUDED__
...
#define    PEOP            0       // PSC End of Cycle Interrupt
#define    PEV0            1       // PSC External Event 0 Interrupt
#define    PEV1            2       // PSC External Event 1 Interrupt
#define    PEV2            3       // PSC External Event 2 Interrupt

/* PIM - PSC Interrupt Mask Register */
#define    PEOPE           0       // PSC End of Cycle Interrupt Enable
#define    PEVE0           1       // External Event 0 Interrupt Enable
#define    PEVE1           2       // External Event 1 Interrupt Enable
#define    PEVE2           3       // External Event 2 Interrupt Enable

/* PMIC2 - PSC Module 2 Input Control Register */
#define    PRFM20          0       // PSC Module 2 Input Mode bit 0
#define    PRFM21          1       // PSC Module 2 Input Mode bit 1
#define    PRFM22          2       // PSC Module 2 Input Mode bit 2
#define    PAOC2           3       // PSC Module 2 Asynchronous Output Control
#define    PFLTE2          4       // PSC Module 2 Input Filter Enable
#define    PELEV2          5       // PSC Module 2 Input Level Selector
#define    PISEL2          6       // PSC Module 2 Input Select
#define    POVEN2          7       // PSC Module 2 Overlap Enable

/* PMIC1 - PSC Module 1 Input Control Register */
#define    PRFM10          0       // PSC Module 1 Input Mode bit 0
#define    PRFM11          1       // PSC Module 1 Input Mode bit 1
#define    PRFM12          2       // PSC Module 1 Input Mode bit 2
#define    PAOC1           3       // PSC Module 1 Asynchronous Output Control
#define    PFLTE1          4       // PSC Module 1 Input Filter Enable
#define    PELEV1          5       // PSC Module 1 Input Level Selector
#define    PISEL1          6       // PSC Module 1 Input Select
#define    POVEN1          7       // PSC Module 1 Overlap Enable

/* PMIC0 - PSC Module 0 Input Control Register */
#define    PRFM00          0       // PSC Module 0 Input Mode bit 0
#define    PRFM01          1       // PSC Module 0 Input Mode bit 1
#define    PRFM02          2       // PSC Module 0 Input Mode bit 2
#define    PAOC0           3       // PSC Module 0 Asynchronous Output Control
#define    PFLTE0          4       // PSC Module 0 Input Filter Enable
#define    PELEV0          5       // PSC Module 0 Input Level Selector
#define    PISEL0          6       // PSC Module 0 Input Select
#define    POVEN0          7       // PSC Module 0 Overlap Enable

/* PCTL - PSC Control Register */
#define    PRUN            0       // PSC Run
#define    PCCYC           1       // PSC Complete Cycle
#define    PCLKSEL         5       // PSC Input Clock Select
#define    PPRE0           6       // PSC Prescaler Select bit 0
#define    PPRE1           7       // PSC Prescaler Select bit 1

/* POC - PSC Output Configuration */
#define    POEN0A          0       // PSC Output 0A Enable
#define    POEN0B          1       // PSC Output 0B Enable
#define    POEN1A          2       // PSC Output 1A Enable
#define    POEN1B          3       // PSC Output 1B Enable
#define    POEN2A          4       // PSC Output 2A Enable
#define    POEN2B          5       // PSC Output 2B Enable

/* PCNF - PSC Configuration Register */
#define    POPA            2       // PSC Output A Polarity
#define    POPB            3       // PSC Output B Polarity
#define    PMODE           4       // PSC Mode
#define    PULOCK          5       // PSC Update Lock

/* PSYNC - PSC Synchro Configuration */
#define    PSYNC00         0       // Selection of Synchronization Out for ADC
#define    PSYNC01         1       // Selection of Synchronization Out for ADC
#define    PSYNC10         2       // Selection of Synchronization Out for ADC
#define    PSYNC11         3       // Selection of Synchronization Out for ADC
#define    PSYNC20         4       // Selection of Synchronization Out for ADC
#define    PSYNC21         5       // Selection of Synchronization Out for ADC
