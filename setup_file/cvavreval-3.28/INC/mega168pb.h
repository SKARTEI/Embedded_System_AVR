// CodeVisionAVR V3.17+ C Compiler
// (C) 1998-2014 Pavel Haiduc, HP InfoTech S.R.L.

// I/O registers definitions for the ATmega168PB

#ifndef _MEGA168PB_INCLUDED_
#define _MEGA168PB_INCLUDED_
...
#define DEVICE_ID0 (*(unsigned char *) 0xf0)
#define DEVICE_ID1 (*(unsigned char *) 0xf1)
#define DEVICE_ID2 (*(unsigned char *) 0xf2)
#define DEVICE_ID3 (*(unsigned char *) 0xf3)
#define DEVICE_ID4 (*(unsigned char *) 0xf4)
#define DEVICE_ID5 (*(unsigned char *) 0xf5)
#define DEVICE_ID6 (*(unsigned char *) 0xf6)
#define DEVICE_ID7 (*(unsigned char *) 0xf7)
#define DEVICE_ID8 (*(unsigned char *) 0xf8)
