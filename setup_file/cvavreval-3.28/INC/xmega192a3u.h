...
// Peripheral Modules and Interrupt Vector definitions for the ATxmega192A3U

#ifndef __XMEGA192A3U_INCLUDED__
#define __XMEGA192A3U_INCLUDED__
...
#include <xmbits_a3u.h> // bit definitions for the Peripheral Modules registers
