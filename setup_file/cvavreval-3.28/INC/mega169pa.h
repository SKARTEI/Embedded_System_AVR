...
// I/O registers definitions for the ATmega169A/PA

#ifndef _MEGA169A_INCLUDED_
#define _MEGA169A_INCLUDED_
...
#define LCDDR0 (*(unsigned char *) 0xec)
#define LCDDR1 (*(unsigned char *) 0xed)
#define LCDDR2 (*(unsigned char *) 0xee)
#define LCDDR3 (*(unsigned char *) 0xef)
#define LCDDR5 (*(unsigned char *) 0xf1)
#define LCDDR6 (*(unsigned char *) 0xf2)
#define LCDDR7 (*(unsigned char *) 0xf3)
#define LCDDR8 (*(unsigned char *) 0xf4)
