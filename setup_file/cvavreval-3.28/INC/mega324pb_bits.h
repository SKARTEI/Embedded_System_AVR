...
ATmega324PB I/O REGISTERS BIT DEFINITIONS
*/

#ifndef __MEGA324PB_BITS_INCLUDED__
#define __MEGA324PB_BITS_INCLUDED__
...
#define    PCIE4           4       // Pin Change Interrupt Enable 4
...
#define    PCIF4           4       // Pin Change Interrupt Flag 4

/* PCMSK4 - Pin Change Mask Register 4 */
#define    PCINT32         0       // Pin Change Enable Mask 32
#define    PCINT33         1       // Pin Change Enable Mask 33
#define    PCINT34         2       // Pin Change Enable Mask 34
#define    PCINT35         3       // Pin Change Enable Mask 35
#define    PCINT36         4       // Pin Change Enable Mask 36
#define    PCINT37         5       // Pin Change Enable Mask 37
#define    PCINT38         6       // Pin Change Enable Mask 38
...
#define    CS30            0       // Clock Select bit 0
#define    CS31            1       // Clock Select 3 bit 1
#define    CS32            2       // Clock Select3 bit 2
#define    WGM32           3       // Waveform Generation Mode Bit 2
#define    WGM33           4       // Waveform Generation Mode Bit 3
...
#define    OCR3AH0         0       // Timer/Counter3 Output Compare Register High Byte bit 0
#define    OCR3AH1         1       // Timer/Counter3 Output Compare Register High Byte bit 1
#define    OCR3AH2         2       // Timer/Counter3 Output Compare Register High Byte bit 2
#define    OCR3AH3         3       // Timer/Counter3 Output Compare Register High Byte bit 3
#define    OCR3AH4         4       // Timer/Counter3 Output Compare Register High Byte bit 4
#define    OCR3AH5         5       // Timer/Counter3 Output Compare Register High Byte bit 5
#define    OCR3AH6         6       // Timer/Counter3 Output Compare Register High Byte bit 6
#define    OCR3AH7         7       // Timer/Counter3 Output Compare Register High Byte bit 7

/* OCR3BL - Timer/Counter3 Output Compare Register B Low Byte */
#define    OCR3AL0         0       // Timer/Counter3 Output Compare Register Low Byte Bit 0
#define    OCR3AL1         1       // Timer/Counter3 Output Compare Register Low Byte Bit 1
#define    OCR3AL2         2       // Timer/Counter3 Output Compare Register Low Byte Bit 2
#define    OCR3AL3         3       // Timer/Counter3 Output Compare Register Low Byte Bit 3
#define    OCR3AL4         4       // Timer/Counter3 Output Compare Register Low Byte Bit 4
#define    OCR3AL5         5       // Timer/Counter3 Output Compare Register Low Byte Bit 5
#define    OCR3AL6         6       // Timer/Counter3 Output Compare Register Low Byte Bit 6
#define    OCR3AL7         7       // Timer/Counter3 Output Compare Register Low Byte Bit 7
...
#define    SPID00          0       // SPI Data Register bit 0
#define    SPID01          1       // SPI Data Register bit 1
#define    SPID02          2       // SPI Data Register bit 2
#define    SPID03          3       // SPI Data Register bit 3
#define    SPID04          4       // SPI Data Register bit 4
#define    SPID05          5       // SPI Data Register bit 5
#define    SPID06          6       // SPI Data Register bit 6
#define    SPID07          7       // SPI Data Register bit 7

/* SPSR0 - SPI Status Register */
#define    SPI2X0          0       // Double SPI Speed Bit
#define    WCOL0           6       // Write Collision Flag
#define    SPIF0           7       // SPI Interrupt Flag

/* SPCR0 - SPI Control Register */
#define    SPR00           0       // SPI Clock Rate Select 0
#define    SPR01           1       // SPI Clock Rate Select 1
#define    CPHA0           2       // Clock Phase
#define    CPOL0           3       // Clock polarity
#define    MSTR0           4       // Master/Slave Select
#define    DORD0           5       // Data Order
#define    SPE0            6       // SPI Enable
#define    SPIE0           7       // SPI Interrupt Enable

/* ***** SPI1 ************************** */
/* SPDR1 - SPI Data Register */
#define    SPID10          0       // SPI Data Register bit 0
#define    SPID11          1       // SPI Data Register bit 1
#define    SPID12          2       // SPI Data Register bit 2
#define    SPID13          3       // SPI Data Register bit 3
#define    SPID14          4       // SPI Data Register bit 4
#define    SPID15          5       // SPI Data Register bit 5
#define    SPID16          6       // SPI Data Register bit 6
#define    SPID17          7       // SPI Data Register bit 7

/* SPSR1 - SPI Status Register */
#define    SPI2X1          0       // Double SPI Speed Bit
#define    WCOL1           6       // Write Collision Flag
#define    SPIF1           7       // SPI Interrupt Flag

/* SPCR1 - SPI Control Register */
#define    SPR10           0       // SPI Clock Rate Select 0
#define    SPR11           1       // SPI Clock Rate Select 1
#define    CPHA1           2       // Clock Phase
#define    CPOL1           3       // Clock polarity
#define    MSTR1           4       // Master/Slave Select
#define    DORD1           5       // Data Order
#define    SPE1            6       // SPI Enable
#define    SPIE1           7       // SPI Interrupt Enable

/* SPSR0, SPSR1 - SPI Status Register, for compatibility with SPI library */
#define    SPI2X          0       // Double SPI Speed Bit
#define    WCOL           6       // Write Collision Flag
#define    SPIF           7       // SPI Interrupt Flag

/* SPCR0, SPCR1 - SPI Control Register, for compatibility with SPI library */
...
#define    UCPHA2          UCSZ20  // For compatibility
#define    UCSZ21          2       // Character Size
#define    UDORD2          UCSZ21  // For compatibility
...
#define    PRSPI0          2      // Power Reduction Serial Peripheral Interface
...
#define    PRTWI0          7       // Power Reduction TWI0

/* PRR1 - Power Reduction Register1 */
#define    PRTIM3          0       // Power Reduction Timer/Counter3
#define    PRTIM4          1       // Power Reduction Timer/Counter4

/* PRR2 - Power Reduction Register2 */
#define    PRTWI1          0       // Power Reduction TWI1
#define    PRSPI1          1       // Power Reduction SPI1
#define    PRUSART2        2       // Power Reduction USART 2
#define    PRPTC           3       // Power Reduction Peripheral Touch Controller
