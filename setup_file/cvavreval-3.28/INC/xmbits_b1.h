...
Peripheral Modules definitions for the ATxmega B1 chips
*************************************************************************/

#ifndef __XMBITS_B1_INCLUDED__
#define __XMBITS_B1_INCLUDED__
...
#define PORTCFG_EVOUTSEL_gm  0x0C  /* Event Output Select group mask. 02082013_3 */
