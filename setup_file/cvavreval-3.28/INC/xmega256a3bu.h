...
// Peripheral Modules and Interrupt Vector definitions for the ATxmega256A3BU

#ifndef __XMEGA256A3BU_INCLUDED__
#define __XMEGA256A3BU_INCLUDED__

#define __RTC32_EXISTS__
#define __VBAT_EXISTS__
...
#include <xmbits_a3bu.h> // bit definitions for the Peripheral Modules registers
...
#define CRC (*(volatile CRC_t *) 0x00D0) // CRC Module
#define VBAT (*(volatile VBAT_t *) 0x00F0) // VBAT Battery Backup Module
...
// RTC32
#define RTC32 (*(volatile RTC32_t *) 0x0420) // Real Time Counter
...
// USB
#define USB_EP_TABLE (*(volatile USB_EP_TABLE_t *))
...
// RTC32
#define RTC32_OVF_vect 11 // Overflow Interrupt
#define RTC32_COMP_vect 12 // Compare Interrupt
...
#define TCC2_LUNF_vect 15  // TCC2 Low Byte Underflow Interrupt
#define TCC0_ERR_vect 16 // Error Interrupt
#define TCC2_HUNF_vect 16  // TCC2 High Byte Underflow Interrupt
...
#define TCE2_LUNF_vect 48  // TCE2 Low Byte Underflow Interrupt
#define TCE0_ERR_vect 49 // Error Interrupt
#define TCE2_HUNF_vect 49  // TCE2 High Byte Underflow Interrupt
#define TCE0_CCA_vect 50 // Compare or Capture A Interrupt
#define TCE2_LCMPA_vect 50  // Low Byte Compare A Interrupt
#define TCE0_CCB_vect 51 // Compare or Capture B Interrupt
#define TCE2_LCMPB_vect 51  // Low Byte Compare B Interrupt
#define TCE0_CCC_vect 52 // Compare or Capture C Interrupt
#define TCE2_LCMPC_vect 52  // Low Byte Compare C Interrupt
#define TCE0_CCD_vect 53 // Compare or Capture D Interrupt
#define TCE2_LCMPD_vect 53  // Low Byte Compare D Interrupt
...
#define TCD2_LUNF_vect 78  // TCD2 Low Byte Underflow Interrupt
#define TCD0_ERR_vect 79 // Error Interrupt
#define TCD2_HUNF_vect 79  // TCD2 High Byte Underflow Interrupt
#define TCD0_CCA_vect 80 // Compare or Capture A Interrupt
#define TCD2_LCMPA_vect 80  // Low Byte Compare A Interrupt
#define TCD0_CCB_vect 81 // Compare or Capture B Interrupt
#define TCD2_LCMPB_vect 81  // Low Byte Compare B Interrupt
#define TCD0_CCC_vect 82 // Compare or Capture C Interrupt
#define TCD2_LCMPC_vect 82  // Low Byte Compare C Interrupt
#define TCD0_CCD_vect 83 // Compare or Capture D Interrupt
#define TCD2_LCMPD_vect 83  // Low Byte Compare D Interrupt
...
#define TCF2_LUNF_vect 109  // TCF2 Low Byte Underflow Interrupt
#define TCF0_ERR_vect 110 // Error Interrupt
#define TCF2_HUNF_vect 110  // TCF2 High Byte Underflow Interrupt
#define TCF0_CCA_vect 111 // Compare or Capture A Interrupt
#define TCF2_LCMPA_vect 111  // Low Byte Compare A Interrupt
#define TCF0_CCB_vect 112 // Compare or Capture B Interrupt
#define TCF2_LCMPB_vect 112  // Low Byte Compare B Interrupt
#define TCF0_CCC_vect 113 // Compare or Capture C Interrupt
#define TCF2_LCMPC_vect 113  // Low Byte Compare C Interrupt
#define TCF0_CCD_vect 114 // Compare or Capture D Interrupt
#define TCF2_LCMPD_vect 114  // Low Byte Compare D Interrupt
...
#define USB_BUSEVENT_vect 126 // SOF, suspend, resume, reset bus event interrupts, crc, underflow, overflow and stall error interrupts
#define USB_TRNCOMPL_vect 127 // Transaction complete interrupt
