...
// I/O registers definitions for the ATtiny2313A

#ifndef _TINY2313A_INCLUDED_
#define _TINY2313A_INCLUDED_

#pragma used+
sfrb USIBR=0; // 19052013_1
sfrb DIDR=1;
sfrb UBRRH=2;
sfrb UCSRC=3;
sfrb PCMSK1=4; // 01022011_4
sfrb PCMSK2=5; // 01022011_4
sfrb PRR=6; // 06082011_1
sfrb ACSR=8;
sfrb UBRRL=9;
sfrb UCSRB=0xa;
sfrb UCSRA=0xb;
...
#define EE_RDY 18
#define WDT 19
#define PC_INT1 20 // 01022011_4
#define PC_INT2 21 // 01022011_4
