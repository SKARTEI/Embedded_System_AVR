...
Peripheral Modules definitions for the ATxmega B3 chips
*************************************************************************/

#ifndef __XMBITS_B3_INCLUDED__
#define __XMBITS_B3_INCLUDED__
...
#define PORTCFG_EVOUTSEL_gm  0x0C  /* Event Output Select bit mask. 02082013_3 */
