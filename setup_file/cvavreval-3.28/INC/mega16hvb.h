...
// I/O registers definitions for the ATmega16HVB

#ifndef _MEGA16HVB_INCLUDED_
#define _MEGA16HVB_INCLUDED_
...
#define BGCSR (*(unsigned char *) 0xd2)
#define CHGDCSR (*(unsigned char *) 0xd4)
...
#define CADICL (*(unsigned char *) 0xe4)
#define CADICH (*(unsigned char *) 0xe5)
#define CADCSRA (*(unsigned char *) 0xe6)
#define CADCSRB (*(unsigned char *) 0xe7)
#define CADCSRC (*(unsigned char *) 0xe8)
#define CADRCC (*(unsigned char *) 0xe9)
#define CADRDC (*(unsigned char *) 0xea)
...
#define TIM1_OVF 16
#define TIM0_IC 17
#define TIM0_COMPA 18
#define TIM0_COMPB 19
#define TIM0_OVF 20
#define TWI_BUS_CD 21
#define TWI 22
#define SPI_STC 23
#define VADC 24
#define CCADC_CONV 25
#define CCADC_REC_CUR 26
#define CCADC_ACC 27
#define EE_RDY 28
#define SPM 29
