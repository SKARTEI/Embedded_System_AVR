...
// Peripheral Modules and Interrupt Vector definitions for the ATxmega384A1

#ifndef __XMEGA384A1_INCLUDED__
#define __XMEGA384A1_INCLUDED__

#include <xmstruct.h> // definitions for the Peripheral Module structures
#include <xmbits_a1.h> // bit definitions for the Peripheral Modules registers
...
#define TCF1 (*(volatile TC1_t *) 0x0B40) // Timer/Counter F1
...
// TWI D
#define TWID_TWIS_vect 76 // TWI Slave Interrupt
#define TWID_TWIM_vect 77 // TWI Master Interrupt
...
// PORTQ
#define PORTQ_INT0_vect 95 // External Interrupt 0
#define PORTQ_INT1_vect 96 // External Interrupt 1

// PORTH
#define PORTH_INT0_vect 97 // External Interrupt 0
#define PORTH_INT1_vect 98 // External Interrupt 1

// PORTJ
#define PORTJ_INT0_vect 99 // External Interrupt 0
#define PORTJ_INT1_vect 100 // External Interrupt 1

// PORTK
#define PORTK_INT0_vect 101 // External Interrupt 0
#define PORTK_INT1_vect 102 // External Interrupt 1
...
// TWI F
#define TWIF_TWIS_vect 107 // TWI Slave Interrupt
#define TWIF_TWIM_vect 108 // TWI Master Interrupt
...
// Timer/Counter F1
#define TCF1_OVF_vect 115 // Overflow Interrupt
#define TCF1_ERR_vect 116 // Error Interrupt
#define TCF1_CCA_vect 117 // Compare or Capture A Interrupt
#define TCF1_CCB_vect 118 // Compare or Capture B Interrupt

// SPI F
#define SPIF_INT_vect 119 // SPI Interrupt
...
// USART F1
#define USARTF1_RXC_vect 123 // Reception Complete Interrupt
#define USARTF1_DRE_vect 124 // Data Register Empty Interrupt
#define USARTF1_TXC_vect 125 // Transmission Complete Interrupt
