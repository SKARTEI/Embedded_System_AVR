...
// Peripheral Modules and Interrupt Vector definitions for the ATxmega128B1

#ifndef __XMEGA128B1_INCLUDED__
#define __XMEGA128B1_INCLUDED__
...
#include <xmbits_b1.h> // bit definitions for the Peripheral Modules registers
...
#define OSC_OSCF_vect      2  // Oscillator Failure Interrupt (NMI) 
...
#define TCC2_LUNF_vect      15  // Low Byte Underflow Interrupt 

// TCC0 interrupt vectors 
#define TCC0_ERR_vect      16  // Error Interrupt 

// TCC2 interrupt vectors 
#define TCC2_HUNF_vect      16  // High Byte Underflow Interrupt 

// TCC0 interrupt vectors 
#define TCC0_CCA_vect      17  // Compare or Capture A Interrupt 

// TCC2 interrupt vectors 
#define TCC2_LCMPA_vect      17  // Low Byte Compare A Interrupt 

// TCC0 interrupt vectors 
#define TCC0_CCB_vect      18  // Compare or Capture B Interrupt 

// TCC2 interrupt vectors 
#define TCC2_LCMPB_vect      18  // Low Byte Compare B Interrupt 

// TCC0 interrupt vectors 
#define TCC0_CCC_vect      19  // Compare or Capture C Interrupt 

// TCC2 interrupt vectors 
#define TCC2_LCMPC_vect      19  // Low Byte Compare C Interrupt 

// TCC0 interrupt vectors 
#define TCC0_CCD_vect      20  // Compare or Capture D Interrupt 

// TCC2 interrupt vectors 
#define TCC2_LCMPD_vect      20  // Low Byte Compare D Interrupt 
...
#define USB_BUSEVENT_vect      32  // SOF, suspend, resume, reset bus event interrupts, crc, underflow, overflow and stall error interrupts 
#define USB_TRNCOMPL_vect      33  // Transaction complete interrupt 

// LCD interrupt vectors 
#define LCD_INT_vect      36  // LCD Interrupt 

// AES interrupt vectors 
#define AES_INT_vect      37  // AES Interrupt 

// NVM interrupt vectors 
#define NVM_EE_vect      38  // EE Interrupt 
#define NVM_SPM_vect      39  // SPM Interrupt 

// PORTB interrupt vectors 
#define PORTB_INT0_vect      40  // External Interrupt 0 
#define PORTB_INT1_vect      41  // External Interrupt 1 

// ACB interrupt vectors 
#define ACB_AC0_vect      42  // AC0 Interrupt 
#define ACB_AC1_vect      43  // AC1 Interrupt 
#define ACB_ACW_vect      44  // ACW Window Mode Interrupt 

// ADCB interrupt vectors 
#define ADCB_CH0_vect      45  // Interrupt 0 

// PORTD interrupt vectors 
#define PORTD_INT0_vect      49  // External Interrupt 0 
#define PORTD_INT1_vect      50  // External Interrupt 1 

// PORTG interrupt vectors 
#define PORTG_INT0_vect      51  // External Interrupt 0 
#define PORTG_INT1_vect      52  // External Interrupt 1 

// PORTM interrupt vectors 
#define PORTM_INT0_vect      53  // External Interrupt 0 
#define PORTM_INT1_vect      54  // External Interrupt 1 

// PORTE interrupt vectors 
#define PORTE_INT0_vect      55  // External Interrupt 0 
#define PORTE_INT1_vect      56  // External Interrupt 1 

// TCE0 interrupt vectors 
#define TCE0_OVF_vect      59  // Overflow Interrupt 

// TCE2 interrupt vectors 
#define TCE2_LUNF_vect      59  // Low Byte Underflow Interrupt 

// TCE0 interrupt vectors 
#define TCE0_ERR_vect      60  // Error Interrupt 

// TCE2 interrupt vectors 
#define TCE2_HUNF_vect      60  // High Byte Underflow Interrupt 

// TCE0 interrupt vectors 
#define TCE0_CCA_vect      61  // Compare or Capture A Interrupt 

// TCE2 interrupt vectors 
#define TCE2_LCMPA_vect      61  // Low Byte Compare A Interrupt 

// TCE0 interrupt vectors 
#define TCE0_CCB_vect      62  // Compare or Capture B Interrupt 

// TCE2 interrupt vectors 
#define TCE2_LCMPB_vect      62  // Low Byte Compare B Interrupt 

// TCE0 interrupt vectors 
#define TCE0_CCC_vect      63  // Compare or Capture C Interrupt 

// TCE2 interrupt vectors 
#define TCE2_LCMPC_vect      63  // Low Byte Compare C Interrupt 

// TCE0 interrupt vectors 
#define TCE0_CCD_vect      64  // Compare or Capture D Interrupt 

// TCE2 interrupt vectors 
#define TCE2_LCMPD_vect      64  // Low Byte Compare D Interrupt 

// USARTE0 interrupt vectors 
#define USARTE0_RXC_vect      70  // Reception Complete Interrupt 
#define USARTE0_DRE_vect      71  // Data Register Empty Interrupt 
#define USARTE0_TXC_vect      72  // Transmission Complete Interrupt 

// PORTA interrupt vectors 
#define PORTA_INT0_vect      76  // External Interrupt 0 
#define PORTA_INT1_vect      77  // External Interrupt 1 

// ACA interrupt vectors 
#define ACA_AC0_vect      78  // AC0 Interrupt 
#define ACA_AC1_vect      79  // AC1 Interrupt 
#define ACA_ACW_vect      80  // ACW Window Mode Interrupt 

// ADCA interrupt vectors 
#define ADCA_CH0_vect      81  // Interrupt 0 
