...
Peripheral Modules definitions for the ATxmega A3BU chips
*************************************************************************/

#ifndef __XMBITS_A3BU_INCLUDED__
#define __XMBITS_A3BU_INCLUDED__
...
typedef struct AC_struct
{
    ...
    register8_t STATUS;  /* Status */
    register8_t CURRCTRL;  /* Current Source Control Register 02082013_1 */ 
    register8_t CURRCALIB;  /* Current Source Calibration Register 02082013_1 */
} AC_t;
...
sfrb GPIO_GPIOR0=0x0000;
sfrb GPIO_GPIOR1=0x0001;
sfrb GPIO_GPIOR2=0x0002;
sfrb GPIO_GPIOR3=0x0003;
sfrb GPIO_GPIOR4=0x0004;
sfrb GPIO_GPIOR5=0x0005;
sfrb GPIO_GPIOR6=0x0006;
sfrb GPIO_GPIOR7=0x0007;
sfrb GPIO_GPIOR8=0x0008;
sfrb GPIO_GPIOR9=0x0009;
sfrb GPIO_GPIORA=0x000A;
sfrb GPIO_GPIORB=0x000B;
sfrb GPIO_GPIORC=0x000C;
sfrb GPIO_GPIORD=0x000D;
sfrb GPIO_GPIORE=0x000E;
sfrb GPIO_GPIORF=0x000F;

/* Deprecated */
sfrb GPIO_GPIO0=0x0000;
sfrb GPIO_GPIO1=0x0001;
sfrb GPIO_GPIO2=0x0002;
sfrb GPIO_GPIO3=0x0003;
sfrb GPIO_GPIO4=0x0004;
sfrb GPIO_GPIO5=0x0005;
sfrb GPIO_GPIO6=0x0006;
sfrb GPIO_GPIO7=0x0007;
sfrb GPIO_GPIO8=0x0008;
sfrb GPIO_GPIO9=0x0009;
sfrb GPIO_GPIOA=0x000A;
sfrb GPIO_GPIOB=0x000B;
sfrb GPIO_GPIOC=0x000C;
sfrb GPIO_GPIOD=0x000D;
sfrb GPIO_GPIOE=0x000E;
sfrb GPIO_GPIOF=0x000F;

/* VPORT0 - Virtual Port 0 */
sfrb VPORT0_DIR=0x0010;
sfrb VPORT0_OUT=0x0011;
sfrb VPORT0_IN=0x0012;
sfrb VPORT0_INTFLAGS=0x0013;

/* VPORT1 - Virtual Port 1 */
sfrb VPORT1_DIR=0x0014;
sfrb VPORT1_OUT=0x0015;
sfrb VPORT1_IN=0x0016;
sfrb VPORT1_INTFLAGS=0x0017;

/* VPORT2 - Virtual Port 2 */
sfrb VPORT2_DIR=0x0018;
sfrb VPORT2_OUT=0x0019;
sfrb VPORT2_IN=0x001A;
sfrb VPORT2_INTFLAGS=0x001B;

/* VPORT3 - Virtual Port 3 */
sfrb VPORT3_DIR=0x001C;
sfrb VPORT3_OUT=0x001D;
sfrb VPORT3_IN=0x001E;
sfrb VPORT3_INTFLAGS=0x001F;

/* OCD - On-Chip Debug System */
sfrb OCD_OCDR0=0x002E;
sfrb OCD_OCDR1=0x002F;

/* CPU - CPU Registers */
sfrb CPU_CCP=0x0034;
sfrb CPU_RAMPD=0x0038;
sfrb CPU_RAMPX=0x0039;
sfrb CPU_RAMPY=0x003A;
sfrb CPU_RAMPZ=0x003B;
sfrb CPU_EIND=0x003C;
sfrb CPU_SPL=0x003D;
sfrb CPU_SPH=0x003E;
sfrb CPU_SREG=0x003F;
...
#define ACA_CURRCTRL  _SFR_MEM8(0x0388) // 02082013_1
#define ACA_CURRCALIB  _SFR_MEM8(0x0389) // 02082013_1
...
#define ACB_CURRCTRL  _SFR_MEM8(0x0398) // 02082013_1
#define ACB_CURRCALIB  _SFR_MEM8(0x0399) // 02082013_1
...
#define USART_BSCALE_bp  4  /* Baud Rate Scale group position for compatibility with V2.0 */
...
/* Fuse Byte 0 */
#define FUSE_JTAGUSERID0  (unsigned char)~__BM(0)  /* JTAG User ID Bit 0 */
#define FUSE_JTAGUSERID1  (unsigned char)~__BM(1)  /* JTAG User ID Bit 1 */
#define FUSE_JTAGUSERID2  (unsigned char)~__BM(2)  /* JTAG User ID Bit 2 */
#define FUSE_JTAGUSERID3  (unsigned char)~__BM(3)  /* JTAG User ID Bit 3 */
#define FUSE_JTAGUSERID4  (unsigned char)~__BM(4)  /* JTAG User ID Bit 4 */
#define FUSE_JTAGUSERID5  (unsigned char)~__BM(5)  /* JTAG User ID Bit 5 */
#define FUSE_JTAGUSERID6  (unsigned char)~__BM(6)  /* JTAG User ID Bit 6 */
#define FUSE_JTAGUSERID7  (unsigned char)~__BM(7)  /* JTAG User ID Bit 7 */
#define FUSE0_DEFAULT  (0xFF)

/* Fuse Byte 1 */
#define FUSE_WDP0  (unsigned char)~__BM(0)  /* Watchdog Timeout Period Bit 0 */
#define FUSE_WDP1  (unsigned char)~__BM(1)  /* Watchdog Timeout Period Bit 1 */
#define FUSE_WDP2  (unsigned char)~__BM(2)  /* Watchdog Timeout Period Bit 2 */
#define FUSE_WDP3  (unsigned char)~__BM(3)  /* Watchdog Timeout Period Bit 3 */
#define FUSE_WDWP0  (unsigned char)~__BM(4)  /* Watchdog Window Timeout Period Bit 0 */
#define FUSE_WDWP1  (unsigned char)~__BM(5)  /* Watchdog Window Timeout Period Bit 1 */
#define FUSE_WDWP2  (unsigned char)~__BM(6)  /* Watchdog Window Timeout Period Bit 2 */
#define FUSE_WDWP3  (unsigned char)~__BM(7)  /* Watchdog Window Timeout Period Bit 3 */
#define FUSE1_DEFAULT  (0xFF)

/* Fuse Byte 2 */
#define FUSE_BODPD0  (unsigned char)~__BM(0)  /* BOD Operation in Power-Down Mode Bit 0 */
#define FUSE_BODPD1  (unsigned char)~__BM(1)  /* BOD Operation in Power-Down Mode Bit 1 */
#define FUSE_TOSCSEL  (unsigned char)~__BM(5)  /* Timer Oscillator pin location */
#define FUSE_BOOTRST  (unsigned char)~__BM(6)  /* Boot Loader Section Reset Vector */
#define FUSE2_DEFAULT  (0xFF)

/* Fuse Byte 3 Reserved */

/* Fuse Byte 4 */
#define FUSE_JTAGEN  (unsigned char)~__BM(0)  /* JTAG Interface Enable */
#define FUSE_WDLOCK  (unsigned char)~__BM(1)  /* Watchdog Timer Lock */
#define FUSE_SUT0  (unsigned char)~__BM(2)  /* Start-up Time Bit 0 */
#define FUSE_SUT1  (unsigned char)~__BM(3)  /* Start-up Time Bit 1 */
#define FUSE_RSTDISBL  (unsigned char)~__BM(4)  /* External Reset Disable */
#define FUSE4_DEFAULT  (0xFF)

/* Fuse Byte 5 */
#define FUSE_BODLVL0  (unsigned char)~__BM(0)  /* Brown Out Detection Voltage Level Bit 0 */
#define FUSE_BODLVL1  (unsigned char)~__BM(1)  /* Brown Out Detection Voltage Level Bit 1 */
#define FUSE_BODLVL2  (unsigned char)~__BM(2)  /* Brown Out Detection Voltage Level Bit 2 */
#define FUSE_EESAVE  (unsigned char)~__BM(3)  /* Preserve EEPROM Through Chip Erase */
#define FUSE_BODACT0  (unsigned char)~__BM(4)  /* BOD Operation in Active Mode Bit 0 */
#define FUSE_BODACT1  (unsigned char)~__BM(5)  /* BOD Operation in Active Mode Bit 1 */
