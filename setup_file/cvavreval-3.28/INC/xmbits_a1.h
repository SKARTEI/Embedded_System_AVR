...
Peripheral Modules definitions for the ATxmega A1 chips
*************************************************************************/

#ifndef __XMBITS_A1_INCLUDED__
#define __XMBITS_A1_INCLUDED__
...
#define FUSE_BODACT0  (unsigned char)~__BM(2)  /* BOD Operation in Active Mode Bit 0 */
#define FUSE_BODACT1  (unsigned char)~__BM(3)  /* BOD Operation in Active Mode Bit 1 */
