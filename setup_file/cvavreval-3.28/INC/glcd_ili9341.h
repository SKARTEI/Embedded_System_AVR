...
//
// V1.02
// 06092014_2 - Added support for 320x240 landscape display mode.
//
// V1.03
...
#define ILI9341_CMD_GET_TEAR_SCANLINE 0x45 // Get the current scan line
...
#define ILI9341_CMD_SET_CTRL_DISPLAY 0x53 // Set the brightness control block,
...
#define ILI9341_CMD_SET_CONTENT_ADAPTIVE_BRIGHTNESS 0x55 // Set the parameters for the content
                                                         // adaptive brightness
#define ILI9341_CMD_GET_CONTENT_ADAPTIVE_BRIGHTNESS 0x56 // Get the parameters for the content
                                                         // adaptive brightness
