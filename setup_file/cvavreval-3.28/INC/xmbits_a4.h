...
/* Fuse Byte 0 */
#define FUSE_USERID0  (unsigned char)~__BM(0)  /* User ID Bit 0 */
#define FUSE_USERID1  (unsigned char)~__BM(1)  /* User ID Bit 1 */
#define FUSE_USERID2  (unsigned char)~__BM(2)  /* User ID Bit 2 */
#define FUSE_USERID3  (unsigned char)~__BM(3)  /* User ID Bit 3 */
#define FUSE_USERID4  (unsigned char)~__BM(4)  /* User ID Bit 4 */
#define FUSE_USERID5  (unsigned char)~__BM(5)  /* User ID Bit 5 */
#define FUSE_USERID6  (unsigned char)~__BM(6)  /* User ID Bit 6 */
#define FUSE_USERID7  (unsigned char)~__BM(7)  /* User ID Bit 7 */
