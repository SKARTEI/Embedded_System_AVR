...
// Peripheral Modules and Interrupt Vector definitions for the ATxmega32D3

#ifndef __XMEGA32D3_INCLUDED__
#define __XMEGA32D3_INCLUDED__

#include <xmstruct.h> // definitions for the Peripheral Module structures
#include <xmbits_d3.h> // bit definitions for the Peripheral Modules registers
