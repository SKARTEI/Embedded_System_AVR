...
// Peripheral Modules and Interrupt Vector definitions for the ATxmega256A3B

#ifndef __XMEGA256A3B_INCLUDED__
#define __XMEGA256A3B_INCLUDED__

#define __RTC32_EXISTS__
#define __VBAT_EXISTS__

#include <xmstruct.h> // definitions for the Peripheral Module structures
#include <xmbits_a3b.h> // bit definitions for the Peripheral Modules registers
