...
// I/O registers definitions for the ATmega16M1

#ifndef _MEGA16M1_INCLUDED_
#define _MEGA16M1_INCLUDED_
...
#define POCR0SAL (*(unsigned char *) 0xa0)
#define POCR0SAH (*(unsigned char *) 0xa1)
#define POCR0RAL (*(unsigned char *) 0xa2)
#define POCR0RAH (*(unsigned char *) 0xa3)
#define POCR0SBL (*(unsigned char *) 0xa4)
#define POCR0SBH (*(unsigned char *) 0xa5)
#define POCR1SAL (*(unsigned char *) 0xa6)
#define POCR1SAH (*(unsigned char *) 0xa7)
#define POCR1RAL (*(unsigned char *) 0xa8)
#define POCR1RAH (*(unsigned char *) 0xa9)
#define POCR1SBL (*(unsigned char *) 0xaa)
#define POCR1SBH (*(unsigned char *) 0xab)
#define POCR2SAL (*(unsigned char *) 0xac)
#define POCR2SAH (*(unsigned char *) 0xad)
#define POCR2RAL (*(unsigned char *) 0xae)
#define POCR2RAH (*(unsigned char *) 0xaf)
#define POCR2SBL (*(unsigned char *) 0xb0)
#define POCR2SBH (*(unsigned char *) 0xb1)
#define POCR_RBL (*(unsigned char *) 0xb2)
#define POCR_RBH (*(unsigned char *) 0xb3)
#define PSYNC (*(unsigned char *) 0xb4)
#define PCNF (*(unsigned char *) 0xb5)
#define POC (*(unsigned char *) 0xb6)
#define PCTL (*(unsigned char *) 0xb7)
#define PMIC0 (*(unsigned char *) 0xb8)
#define PMIC1 (*(unsigned char *) 0xb9)
#define PMIC2 (*(unsigned char *) 0xba)
#define PIM (*(unsigned char *) 0xbb)
#define PIFR (*(unsigned char *) 0xbc)
