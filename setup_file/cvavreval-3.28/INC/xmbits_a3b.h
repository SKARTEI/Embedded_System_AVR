...
Peripheral Modules definitions for the ATxmega A3B chips
*************************************************************************/

#ifndef __XMBITS_A3B_INCLUDED__
#define __XMBITS_A3B_INCLUDED__
...
#define FUSE_DVSDON  (unsigned char)~__BM(7)  /* Spike Detector Enable */
