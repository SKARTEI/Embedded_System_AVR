...
// Peripheral Modules and Interrupt Vector definitions for the ATxmega128A4

#ifndef __XMEGA128A4_INCLUDED__
#define __XMEGA128A4_INCLUDED__

#include <xmstruct.h> // definitions for the Peripheral Module structures
#include <xmbits_a4.h> // bit definitions for the Peripheral Modules registers
...
#define CPU (*(volatile CPU_t *) 0x0030) // CPU
