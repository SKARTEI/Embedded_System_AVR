/*****************************************************************************
  ...
  USED FOR COMMUNICATION WITH THE DS3231
  ...
  // now the rest of the DS3231 functions can be used
  // initialize the DS3231 RTC
  rtc_init(DS3231_INT_SQW_OFF,false);
...
#ifndef _DS3231_TWI_INCLUDED_
#define _DS3231_TWI_INCLUDED_
